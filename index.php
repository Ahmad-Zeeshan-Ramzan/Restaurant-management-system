...
$login_pass=$_POST['pass'];
	if(!empty($login_name) || !empty($login_pass))
	{
		if(!preg_match('/[^a-zA-Z\d]/', $login_name) && !preg_match('/[^a-zA-Z\d]/', $login_pass))
		{
			...
			$login="select * from admin WHERE NAME='".$login_name."' and PASSWORD='".$login_pass."'";
				...
				if(!empty($_POST['remember']))
	{
		...
		{
			echo"please enter your values first";
		}
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="username" name="username" value="<?php if(isset($_COOKIE["username"])) {echo $_COOKIE["username"];}?>" placeholder="Username">
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input class="au-input au-input--full" type="password" name="pass" value="<?php if(isset($_COOKIE["pass"])) {echo $_COOKIE["pass"];}?>" placeholder="Password">
                                </div>
